...
var button = document.querySelector(".ph_btn-3");
button.addEventListener("click", function() {
  MicroModal.show("modal-3");
});

var button = document.querySelector(".ph_btn-4");
button.addEventListener("click", function() {
  MicroModal.show("modal-4");
});

var button = document.querySelector(".ph_btn-5");
button.addEventListener("click", function() {
  MicroModal.show("modal-5");
});

var button = document.querySelector(".ph_btn-6");
button.addEventListener("click", function() {
  MicroModal.show("modal-6");
});

var button = document.querySelector(".ph_btn-7");
button.addEventListener("click", function() {
  MicroModal.show("modal-7");
});

var button = document.querySelector(".ph_btn-8");
button.addEventListener("click", function() {
  MicroModal.show("modal-8");
});

var button = document.querySelector(".ph_btn-9");
button.addEventListener("click", function() {
  MicroModal.show("modal-9");
});

var button = document.querySelector(".ph_btn-10");
button.addEventListener("click", function() {
...
document.addEventListener('DOMContentLoaded', function() {
  var elements = document.querySelectorAll('.hs-richtext.hs-main-font-element');
